...
//        private readonly IHubContext<AppHub> _hub; // inject hub only in controller

//        public PlayerController(IPlayerService service, IHubContext<AppHub> hub)
//        {
//            _service = service;
//            _hub = hub;
//        }
...
//            await _hub.Clients.All.SendAsync("PlayerCreated", player); // 🔔 broadcast here
//            return Ok(player);
//        }
...
//            if (player == null) return NotFound();
//            await _hub.Clients.All.SendAsync("PlayerUpdated", player); // 🔔 broadcast here
//            return Ok(player);
//        }
...
//            await _hub.Clients.All.SendAsync("PlayerDeleted", id); // 🔔 broadcast here
//            return Ok();
//        }
//    }
//}
